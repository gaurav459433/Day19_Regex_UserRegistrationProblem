...
public class UserRegistration {
    ...
    public static UserRegistrationInterface lastNameValidate = new UserRegistrationInterface() {
    ...
    public static UserRegistrationInterface emailValidate = new UserRegistrationInterface() {
    ...
    public static UserRegistrationInterface phoneNumberValidate = new UserRegistrationInterface() {
    ...
    public static UserRegistrationInterface passwordValidate = new UserRegistrationInterface() {
